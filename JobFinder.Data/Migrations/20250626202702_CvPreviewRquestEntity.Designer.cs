...
namespace JobFinder.Data.Migrations
{
    ...
    [Migration("20250626202702_CvPreviewRquestEntity")]
    partial class CvPreviewRquestEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceCityEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AnonymousProfileAppearanceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AnonymousProfileAppearanceId");

                    b.HasIndex("CityId");

                    b.ToTable("AnonymousProfileAppearancesCities");
                });

            modelBuilder.Entity("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceITAreaEntity", b =>
                {
                    ...
                    b.HasKey("AnonymousProfileAppearanceId", "ITAreaId");

                    b.HasIndex("ITAreaId");

                    b.ToTable("AnonymousProfileAppearancesITAreas");
                });

            modelBuilder.Entity("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceJobEngagementEntity", b =>
                {
                    b.Property<int>("AnonymousProfileAppearanceId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AnonymousProfileAppearanceId", "JobEngagementId");

                    b.HasIndex("JobEngagementId");

                    b.ToTable("AnonymousProfileAppearancesJobEngagements");
                });

            modelBuilder.Entity("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceSoftSkillEntity", b =>
                {
                    b.Property<int>("AnonymousProfileAppearanceId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AnonymousProfileAppearanceId", "SoftSkillId");

                    b.HasIndex("SoftSkillId");

                    b.ToTable("AnonymousProfileAppearancesSoftSkills");
                });

            modelBuilder.Entity("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceTechStackEntity", b =>
                {
                    b.Property<int>("AnonymousProfileAppearanceId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AnonymousProfileAppearanceId", "TechStackId");

                    b.HasIndex("TechStackId");

                    b.ToTable("AnonymousProfileAppearancesTechStacks");
                });

            modelBuilder.Entity("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceWorkplaceTypeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AnonymousProfileAppearancesWorkplaceTypes");
                });
            ...
            modelBuilder.Entity("JobFinder.Data.Models.Cv.CourseCertificateEntity", b =>
                {
                    ...
                    b.Property<bool?>("IncludeInAnonymousProfile")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("JobFinder.Data.Models.Cv.CvPreviewRequestEntity", b =>
                {
                    ...
                    b.Property<string>("AnonymousProfilePreviewedId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("AnonymousProfilePreviewedId");

                    b.HasIndex("JobAdId");

                    b.ToTable("CvPreviewRequests");
                });
            ...
            modelBuilder.Entity("JobFinder.Data.Models.JobAdEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("JobAdvertisements", t =>
                        {
                            t.HasCheckConstraint("CHK_JobAdvertisements_MinSalary_MaxSalary_Currency", "(CurrencyId IS NOT NULL AND MinSalary IS NOT NULL AND MaxSalary IS NOT NULL AND MinSalary <= MaxSalary)\r\n                        OR (CurrencyId IS NULL AND MinSalary IS NULL AND MaxSalary IS NULL)\r\n                     ");
                        });
                });

            modelBuilder.Entity("JobFinder.Data.Models.JobAdItAreaEntity", b =>
                {
                    b.Property<int>("JobAdId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("JobAdId", "ItAreaId");

                    b.HasIndex("ItAreaId");

                    b.ToTable("JobAdsItAreas");
                });

            modelBuilder.Entity("JobFinder.Data.Models.JobAdSoftSkillEntity", b =>
                {
                    b.Property<int>("JobAdId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("JobAdId", "SoftSkillId");

                    b.HasIndex("SoftSkillId");

                    b.ToTable("JobAdsSoftSkills");
                });

            modelBuilder.Entity("JobFinder.Data.Models.JobAdTechStackEntity", b =>
                {
                    b.Property<int>("JobAdId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("JobAdId", "TechStackId");

                    b.HasIndex("TechStackId");

                    b.ToTable("JobAdsTechStacks");
                });
            ...
            modelBuilder.Entity("JobFinder.Data.Models.Nomenclature.ItAreaEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobFinder.Data.Models.Nomenclature.TechStackEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobFinder.Data.Models.Nomenclature.WorkplaceTypeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceCityEntity", b =>
                {
                    b.HasOne("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceEntity", "AnonymousProfileAppearance")
                        .WithMany("Cities")
                        .HasForeignKey("AnonymousProfileAppearanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JobFinder.Data.Models.Nomenclature.CityEntity", "City")
                        .WithMany()
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AnonymousProfileAppearance");
            ...
            modelBuilder.Entity("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceITAreaEntity", b =>
                {
                    ...
                    b.HasOne("JobFinder.Data.Models.Nomenclature.ItAreaEntity", "ITArea")
                        .WithMany()
                        .HasForeignKey("ITAreaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceSoftSkillEntity", b =>
                {
                    ...
                    b.HasOne("JobFinder.Data.Models.Nomenclature.SoftSKillEntity", "SoftSkill")
                        .WithMany()
            ...
            modelBuilder.Entity("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceTechStackEntity", b =>
                {
                    ...
                    b.HasOne("JobFinder.Data.Models.Nomenclature.TechStackEntity", "TechStack")
                        .WithMany()
            ...
            modelBuilder.Entity("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceWorkplaceTypeEntity", b =>
                {
                    b.HasOne("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileAppearanceEntity", "AnonymousProfileAppearance")
                        .WithMany("WorkplaceTypes")
                        .HasForeignKey("AnonymousProfileAppearanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JobFinder.Data.Models.Nomenclature.WorkplaceTypeEntity", "WorkplaceType")
                        .WithMany()
            ...
            modelBuilder.Entity("JobFinder.Data.Models.Cv.CvPreviewRequestEntity", b =>
                {
                    b.HasOne("JobFinder.Data.Models.AnonymousProfile.AnonymousProfileEntity", "AnonymousProfilePreviewed")
                        .WithMany()
                        .HasForeignKey("AnonymousProfilePreviewedId");
                    ...
                    b.Navigation("AnonymousProfilePreviewed");
            ...
            modelBuilder.Entity("JobFinder.Data.Models.Subscriptions.JobsSubscriptionEntity", b =>
                {
                    ...
                    b.HasOne("JobFinder.Data.Models.Nomenclature.RecurringTypeEntity", "RecurringType")
            ...
            modelBuilder.Entity("JobFinder.Data.Models.JobAdEntity", b =>
                {
                    ...
                    b.Navigation("JobAdITAreas");

                    b.Navigation("JobAdSoftSkills");

                    b.Navigation("JobAdTechStacks");
                });
